...
palette.update({
    ...
    "return label": ("h16", "h252"),
    "return value": ("h16", "h252"),
    "focused return label": (add_setting("h16", "bold"), "h252"),
    "focused return value": ("h252", "white"),
    # }}}
    ...
    "current highlighted source": (add_setting("h16", "bold"), "h252"),
    ...
    # {{{ shell
    "command line edit": ("h16", "h252"),
    "command line prompt": (add_setting("h16", "bold"), "h252"),
    ...
    "command line clear button": ("h16", "h252"),
    "command line focused button": ("h16", "white"),
    # }}}
