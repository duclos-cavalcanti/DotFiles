...
function FormatTabName(sel_bool, mod_bool, bufname, i, num_windows)
    ...
    if a:sel_bool && !a:mod_bool        | let l:str .= '%#TabLineSel#'
    elseif a:sel_bool && a:mod_bool     | let l:str .= '%#CustomTabModLine#'
    elseif a:mod_bool                   | let l:str .= '%#CustomTabModLine#'
    else                                | let l:str .= '%#TabLine#'
    endif
